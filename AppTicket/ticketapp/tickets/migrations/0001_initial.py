    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img_name', cloudinary.models.CloudinaryField(blank=True, max_length=255, null=True, verbose_name='img_name')),
            ],
            options={
                'ordering': ['-id'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='tickets.chatroom')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.IntegerField(default=0)),
                ('receipt', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='tickets', to='tickets.receipt')),
                ('ticket_type', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='tickets', to='tickets.ticket_type')),
            ],
            options={
                'ordering': ['-id'],
                'abstract': False,
