# Generated by Django 5.2.1 on 2025-05-10 09:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='receipt', to='tickets.registration')),
            ],
            options={
                'ordering': ['-id'],
                'abstract': False,
